...
| <a name="output_sops_secrets_operator_iam_user_arn"></a> [sops\_secrets\_operator\_iam_user_arn](#output\_sops\_secrets\_operator\_iam_user_arn) | IAM user ARN for the k3s sops-secrets-operator |
